...
public class AgendamentoController {
    ...
    @PutMapping
    public ResponseEntity<Agendamento> alterarAgendamentos(@RequestBody Agendamento agendamento, @RequestParam String cliente, LocalDateTime dataHoraAgendamento){
